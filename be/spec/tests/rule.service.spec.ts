...
describe('rule.service', () => {
    ...
    it('test addOrUpdateRules & updateRuleStatus', async () => {
        ...
        const rule: Rule = rules.find((_: Rule) => _.name === name);
        ...
        const rule2: Rule = rules2.find((_: Rule) => _.name === name2);
        ...
        const rule3: Rule = rules3.find((_: Rule) => _.name === name2);
        ...
        const rule4: Rule = rules4.find((_: Rule) => _.name === name2);
