...
class JobService {
     ...
     *  ================================
     */
    async getJobDetailsById(jobId: number, lastLogId?: number): Promise<JobAndLogs> {
...
const s = new JobService();
export const
    getJobDetailsById = s.getJobDetailsById.bind(s),
    getAllJobs = s.getAllJobs.bind(s),
    getJobById = s.getJobById.bind(s);