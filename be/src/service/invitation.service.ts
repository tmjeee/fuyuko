...
class InvitationService {
     ...
     */
    async createInvitation(email: string, groupIds: number[] = [], sendMail:boolean = true, invitationCode?: string): Promise<string[]> {
     ...
     * ================================
     */
    async activateInvitation(code: string, username: string, email: string, firstName: string,
...
const s = new InvitationService()
export const
    createInvitation = s.createInvitation.bind(s),
    activateInvitation = s.activateInvitation.bind(s),
    getInvitationByCode = s.getInvitationByCode.bind(s);