...
class ViewService {
     ...
     *  ==================================
     */
    async addOrUpdateViews(views: AddOrUpdateViewsInput): Promise<string[]> {
     ...
     *  ==================================
     */
    async getViewById(viewId: number): Promise<View> {
     ...
     *  ==================================
     */
    async getViewByName(viewName: string): Promise<View> {
        const view: View = await doInDbConnection(async (conn: Connection) => {
...
export const
    deleteView = s.deleteView.bind(s),
    addOrUpdateViews = s.addOrUpdateViews.bind(s),
    getAllViews = s.getAllViews.bind(s),
    getViewById = s.getViewById.bind(s),
    getViewByName = s.getViewByName.bind(s);