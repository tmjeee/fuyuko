...
import * as u  from "../../service/workflow-utils.service";
import {createState2} from "../../wf/engine-utils";
import _ from 'lodash';
import {StateLike} from "../../service/workflow-utils.service";
...
const state1 = createState2('state1',
    {
        initFn: async (args) => {
...
const state2 = createState('state1',
    ...
    async (prevState: State | undefined, args) => {
        const s = { state: state2, args };
