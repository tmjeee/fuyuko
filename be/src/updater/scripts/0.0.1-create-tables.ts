...
const ADD_FK_CONSTRAINT = async () => {
   await doInDbConnection(async (conn: PoolConnection) => {
      ...
      await conn.query(`ALTER TABLE TBL_ITEM_ATTRIBUTE ADD CONSTRAINT \`fk_tbl_item_attribute-1\` FOREIGN KEY IF NOT EXISTS (VIEW_ID) REFERENCES TBL_VIEW(ID)`);
      await conn.query(`ALTER TABLE TBL_ITEM_ATTRIBUTE_METADATA ADD CONSTRAINT \`fk_tbl_item_attribute_metadata-1\` FOREIGN KEY IF NOT EXISTS (ITEM_ATTRIBUTE_ID) REFERENCES TBL_ITEM_ATTRIBUTE(ID)`);
      await conn.query(`ALTER TABLE TBL_ITEM_ATTRIBUTE_METADATA_ENTRY ADD CONSTRAINT \`fk_tbl_item_attribute_metadata_entry-1\` FOREIGN KEY IF NOT EXISTS (ITEM_ATTRIBUTE_METADATA_ID) REFERENCES TBL_ITEM_ATTRIBUTE_METADATA(ID) ON DELETE CASCADE`);
      ...
      await conn.query(`ALTER TABLE TBL_ITEM_VALUE ADD CONSTRAINT \`fk_tbl_item_value-2\` FOREIGN KEY IF NOT EXISTS (ITEM_ATTRIBUTE_ID) REFERENCES TBL_ITEM_ATTRIBUTE(ID)`);
      await conn.query(`ALTER TABLE TBL_ITEM_VALUE_METADATA ADD CONSTRAINT \`fk_tbl_item_value_metadata-1\` FOREIGN KEY IF NOT EXISTS (ITEM_VALUE_ID) REFERENCES TBL_ITEM_VALUE(ID)`);
      await conn.query(`ALTER TABLE TBL_ITEM_VALUE_METADATA_ENTRY ADD CONSTRAINT \`fk_tbl_item_value_metadata_entry-1\` FOREIGN KEY IF NOT EXISTS (ITEM_VALUE_METADATA_ID) REFERENCES TBL_ITEM_VALUE_METADATA(ID)`);
      ...
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM ADD CONSTRAINT \`fk_tbl_data_import_item-2\` FOREIGN KEY IF NOT EXISTS (PARENT_ID) REFERENCES TBL_DATA_IMPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_IMAGE ADD CONSTRAINT \`fk_tbl_data_import_item_image-1\` FOREIGN KEY IF NOT EXISTS (DATA_IMPORT_ITEM_ID) REFERENCES TBL_DATA_IMPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_ATTRIBUTE ADD CONSTRAINT \`fk_tbl_data_import_item_attribute-1\` FOREIGN KEY IF NOT EXISTS (DATA_IMPORT_ITEM_ID) REFERENCES TBL_DATA_IMPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_ATTRIBUTE ADD CONSTRAINT \`fk_tbl_data_import_item_attribute-2\` FOREIGN KEY IF NOT EXISTS (ATTRIBUTE_METADATA_ID) REFERENCES TBL_DATA_IMPORT_ITEM_ATTRIBUTE_METADATA(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_ATTRIBUTE_METADATA ADD CONSTRAINT \`fk_tbl_data_import_item_attribute_metadata-1\` FOREIGN KEY IF NOT EXISTS (DATA_IMPORT_ITEM_ATTRIBUTE_ID) REFERENCES TBL_DATA_IMPORT_ITEM_ATTRIBUTE(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_ATTRIBUTE_METADATA_ENTRY ADD CONSTRAINT \`fk_tbl_data_import_item_attribute_metadata_entry-1\` FOREIGN KEY IF NOT EXISTS (DATA_IMPORT_ITEM_ATTRIBUTE_METADATA_ID) REFERENCES TBL_DATA_IMPORT_ITEM_ATTRIBUTE_METADATA(ID)`);
      ...
      await conn.query(`ALTER TABLE TBL_DATA_IMPORT_ITEM_VALUE ADD CONSTRAINT \`fk_tbl_data_import_item_value-2\` FOREIGN KEY IF NOT EXISTS (ITEM_ATTRIBUTE_ID) REFERENCES TBL_DATA_IMPORT_ITEM_ATTRIBUTE(ID)`);
      ...
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM ADD CONSTRAINT \`fk_tbl_data_export_item-2\` FOREIGN KEY IF NOT EXISTS (PARENT_ID) REFERENCES TBL_DATA_EXPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_IMAGE ADD CONSTRAINT \`fk_tbl_data_export_item_image-1\` FOREIGN KEY IF NOT EXISTS (DATA_EXPORT_ITEM_ID) REFERENCES TBL_DATA_EXPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_ATTRIBUTE ADD CONSTRAINT \`fk_tbl_data_export_item_attribute-1\` FOREIGN KEY IF NOT EXISTS (DATA_EXPORT_ITEM_ID) REFERENCES TBL_DATA_EXPORT_ITEM(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_ATTRIBUTE ADD CONSTRAINT \`fk_tbl_data_export_item_attribute-2\` FOREIGN KEY IF NOT EXISTS (ATTRIBUTE_METADATA_ID) REFERENCES TBL_DATA_EXPORT_ITEM_ATTRIBUTE_METADATA(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_ATTRIBUTE_METADATA ADD CONSTRAINT \`fk_tbl_data_export_item_attribute_metadata-1\` FOREIGN KEY IF NOT EXISTS (DATA_EXPORT_ITEM_ATTRIBUTE_ID) REFERENCES TBL_DATA_EXPORT_ITEM_ATTRIBUTE(ID)`);
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_ATTRIBUTE_METADATA_ENTRY ADD CONSTRAINT \`fk_tbl_data_export_item_attribute_metadata_entry-1\` FOREIGN KEY IF NOT EXISTS (DATA_EXPORT_ITEM_ATTRIBUTE_METADATA_ID) REFERENCES TBL_DATA_EXPORT_ITEM_ATTRIBUTE_METADATA(ID)`);
      ...
      await conn.query(`ALTER TABLE TBL_DATA_EXPORT_ITEM_VALUE ADD CONSTRAINT \`fk_tbl_data_export_item_value-2\` FOREIGN KEY IF NOT EXISTS (ITEM_ATTRIBUTE_ID) REFERENCES TBL_DATA_EXPORT_ITEM_ATTRIBUTE(ID)`);
