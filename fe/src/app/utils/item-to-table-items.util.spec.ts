...
describe('item-to-table-items.util.ts', () => {
  ...
  {id: 1, depth: 0, rootParentId: undefined, parentId: undefined, 1: { attributeId: 1, val: { type: 'string', value: 's1' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 2, depth: 0, rootParentId: 1, parentId: 1, 1: { attributeId: 1, val: { type: 'string', value: 's11' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 3, depth: 0, rootParentId: 1, parentId: 1, 1: { attributeId: 1, val: { type: 'string', value: 's12' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 4, depth: 0, rootParentId: 1, parentId: 2, 1: { attributeId: 1, val: { type: 'string', value: 's111' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 5, depth: 0, rootParentId: 1, parentId: 2, 1: { attributeId: 1, val: { type: 'string', value: 's112' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 6, depth: 0, rootParentId: 1, parentId: 4, 1: { attributeId: 1, val: { type: 'string', value: 's1111' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 7, depth: 0, rootParentId: 1, parentId: 6, 1: { attributeId: 1, val: { type: 'string', value: 's11111' } as StringValue} as Value } as TableItem,
    // tslint:disable-next-line:max-line-length
  {id: 8, depth: 0, rootParentId: undefined, parentId: undefined, 1: { attributeId: 1, val: { type: 'string', value: 's2' } as StringValue} as Value } as TableItem,
  ];
