...
const allPricingStructures: PricingStructureWithItems[] = [
    { id: 1, name: 'Pricing Structure #1', description: 'Pricing Structure #1 description',
        items: [
            {
                id: 1, itemId: 1, itemName: 'item #1', itemDescription: 'item #1 description', price: 1.00, country: 'AUD'
            } as PricingStructureItemWithPrice
        ]
    } as PricingStructureWithItems,
    { id: 2, name: 'Pricing Structure #2', description: 'Pricing Structure #2 description',
        items: [
            {
                id: 1, itemId: 1, itemName: 'item #2', itemDescription: 'item #2 description', price: 2.00, country: 'AUD'
            } as PricingStructureItemWithPrice
        ]
    } as PricingStructureWithItems,
];
